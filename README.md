# LLM-Ethics-reasoning-benchmark-research
...
**outputs/:** Store model response logs, evaluation scores, and metric calculations (PDI, MFSS).

**paper/:** Keep your LaTeX source files, figures, and bibliography for the EMNLP submission.
